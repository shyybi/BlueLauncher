...
<h1 align="center">BlueLauncher</h1>
...
You can download from [GitHub Releases](https://github.com/shyybi/BlueLauncher/releases)
...
| Platform | File |
| -------- | ---- |
| Windows x64 | `BlueLauncher-setup-VERSION.exe` |
| macOS x64 | `BlueLauncher-setup-VERSION-x64.dmg` |
| macOS arm64 | `BlueLauncher-setup-VERSION-arm64.dmg` |
| Linux x64 | `BlueLauncher-setup-VERSION.AppImage` |
